...
Models can always be improved by crossvalidating the number of features to extract, though particular attention should be payed not to "double dip" in the data. 
